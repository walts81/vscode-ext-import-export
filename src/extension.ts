...
import { exportExtensions, importExtensions, removeExtensions } from './commands';
...
export function activate(context: vscode.ExtensionContext) {
  ...
  //console.log('Congratulations, your extension "extension-import-export" is now active!');
  ...
  const removeInstalledExtensions = vscode.commands.registerCommand('extension.removeExtensions', () =>
    removeExtensions(context)
  );
